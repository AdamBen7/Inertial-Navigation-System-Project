...
Plotter q;
    ...
    double currtime;
    double g = 9.795;
//6:plot  7:array   8:accel 9:quaternion
    int serialOption = 7;
...
void getSensor(double& ax, double& ay, double& dt){
    ...
    q3 = TheState(12);
/*
 GravityVec(0) = 2*(q1*q3 - q0*q2);
 GravityVec(1) = 2*(q0*q1 + q2*q3);
 GravityVec(2) = q0*q0 - q1*q1 - q2*q2 + q3*q3;
*/



   TransformerMat << q0*q0+q1*q1-q2*q2-q3*q3, 2*(q1*q2-q0*q3), 2*(q1*q3+q0*q2), 
    ...
    GravityVec = TransformerMat.inverse() * GravityVec;
