...
void loop()
{
    short int ax = GY85.accelerometer_x( GY85.readFromAccelerometer() );
    short int ay = GY85.accelerometer_y( GY85.readFromAccelerometer() );
    short int az = GY85.accelerometer_z( GY85.readFromAccelerometer() );
